...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println(str1 == str2); // 참조변수의 비교 -> 주소값 비교
		...
		// 문자열을 붙인다 => "" + "" => concat(Sring s)
		System.out.println(str.concat(" JAVA!!"));
		
		System.out.println("==========================");
		// 문자열에 특정 문자열을 포함 여부 확인 => boolean
		...
		// 문자열의 사이즈 체크 : inEmpty() => str.length() == 0
