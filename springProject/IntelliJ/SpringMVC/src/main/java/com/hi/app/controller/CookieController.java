...
public class CookieController {
    ...
    // /cookie/view
    @RequestMapping("/view")
    public String viewCookie(@CookieValue("userid") String userid, @CookieValue(value = "auth", defaultValue = "not") String auth, @RequestHeader("Referer") String referer, Model model){
