...
public class TodoRegistController {
    ...
    // post : redirect -> /todo/list , view가 필요 없음
    @RequestMapping(method = RequestMethod.POST)
    public String regist(Model model, String todo, String duedate,
                         @RequestParam(value = "todo", required = false) String requestTodo, @RequestParam(value = "duedate", defaultValue = "2023-12-25") String requestDuedate,
        ...
        model.addAttribute("todo", requestTodo);
        model.addAttribute("duedate",requestDuedate);
